...
fun ProductInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            value = productDetails.producto,
            onValueChange = { onValueChange(productDetails.copy(producto = it)) },
            label = { Text(stringResource(R.string.product_producto_req)) },
        ...
        OutlinedTextField(
            ...
            onValueChange = { onValueChange(productDetails.copy(material = it)) },
            label = { Text(stringResource(R.string.product_material_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
...
private fun ProductEntryScreenPreview() {
    InventoryTheme {
        ProductEntryBody(productUiState = ProductUiState(
            ProductDetails(
                producto = "producto", material = "algodon", price = "10.00", quantity = "52"
            )
